...
Installs the node modules that are defined in package.json.
...
In the directory './cypress', you can run:

### `npm run cy:open`

Runs all the integration tests in a new browser.

### `npm run cy:run`

Runs all the integration tests in a terminal.
